...
public class BookLoading extends FrameLayout {
    ...
    private void initView(Context context) {
        LayoutInflater.from(context).inflate(R.layout.loadingbook_loading, this, true);
    ...
    private void addPage() {
        ...
        for (int i = 0; i < PAGE_NUM; i++) {
            ...
            pageView.setTag(R.string.loading_app_name, i);
    ...
    private void setAnim(final View view, long delay) {
        ...
        animator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationStart(Animator animation) {
                if ((int) view.getTag(R.string.loading_app_name) == PAGE_NUM - 1) {
                    view.bringToFront();
                }
            }
