...
public class PageView extends View {
    ...
    private void initView() {
        padding = getResources().getDimension(R.dimen.loadingBook_padding);
        border = getResources().getDimensionPixelOffset(R.dimen.loadingBook_border);

        paint = new Paint();
        paint.setAntiAlias(true);
        paint.setStrokeWidth(getResources().getDimension(R.dimen.loadingBook_border));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.loadingBook_loading_book));
        ...
        paint.setColor(getResources().getColor(R.color.loadingBook_loading_page));
